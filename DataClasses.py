...
class Track():
    ...
    # -- Constructor -- #
    def __init__(self, track_pos: id):
    # -- Properties -- #
        try:
            self.__track_pos = int(track_pos)
        except Exception as e:
            raise Exception('Track needs to be a number')
    # Track position
    @property 
    def track_pos(self):
...
class CD:
    ...
    def __sort_tracks(self):
        """ Sorts tracks using track.position. Fills blanks with None """
        n = len(self.__tracks)
